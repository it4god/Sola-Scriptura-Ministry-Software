...
{
	public class FrmAdmin : Sola_Scriptura_Library.FrmBigMenu
	{
		...
		internal FrmModifyLibrarian MyModifyLibrarianForm;
		public FrmAdmin()
		{
		...
		private void InitializeComponent()
		{
			...
			this.labelAdd.Text = "Add Librarian";
			...
			this.labelEdit.Text = "Edit Librarian";
			...
			this.labelDelete.Text = "Delete Librarian";
			...
			this.labelData.Text = "Librarian Data";
		...
		private void labelAdd_Click(object sender, System.EventArgs e)
		{
			...
			MyLibrarianForm.MyLibrarian.UpdateUser = base.MyMDIForm.LibrarianUserName.ToString();
			MyLibrarianForm.comboBoxLibrarianGroup.Text = "User";
			MyLibrarianForm.DoUnlock();
			MyLibrarianForm.GetMaxLibrarianID ();
		...
		{
			MyModifyLibrarianForm = new FrmModifyLibrarian(this.MyMDIForm);
			MyModifyLibrarianForm.MdiParent = base.MyMDIForm;
			MyModifyLibrarianForm.MyLibrarian = new Librarian();
			MyModifyLibrarianForm.MyLibrarian.UpdateUser = base.MyMDIForm.LibrarianUserName.ToString();
			MyModifyLibrarianForm.LabelTitle.Text = "    Edit Librarian";
			MyModifyLibrarianForm.buttonModify.Text = "Edit";
			MyModifyLibrarianForm.Show();
		}
		...
		private void labelDelete_Click(object sender, System.EventArgs e)
		{
			...
			MyModifyLibrarianForm.MyLibrarian = new Librarian();
			MyModifyLibrarianForm.MyLibrarian.UpdateUser = base.MyMDIForm.LibrarianUserName.ToString();
			MyModifyLibrarianForm.LabelTitle.Text = "    Delete Librarian";
			MyModifyLibrarianForm.buttonModify.Text = "Delete";		
			MyModifyLibrarianForm.Show();
		}
		...
		private void labelData_Click(object sender, System.EventArgs e)
		{
			...
			MyModifyLibrarianForm.MyLibrarian = new Librarian();
			MyModifyLibrarianForm.MyLibrarian.UpdateUser = base.MyMDIForm.LibrarianUserName.ToString();
			MyModifyLibrarianForm.LabelTitle.Text = "    Show Librarian";
			MyModifyLibrarianForm.buttonModify.Text = "Show";
			MyModifyLibrarianForm.Show();
		}
