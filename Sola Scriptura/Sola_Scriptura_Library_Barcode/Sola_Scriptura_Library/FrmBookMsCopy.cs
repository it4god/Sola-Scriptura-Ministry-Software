...
namespace Sola_Scriptura_Library
{
	public class FrmBookMsCopy : Sola_Scriptura_Library.FrmBookMaster
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridBookCopy.Size = new System.Drawing.Size(672, 112);
			...
			this.textBoxCopyNo.Location = new System.Drawing.Point(384, 296);
			...
			this.labelCopyNo.Location = new System.Drawing.Point(256, 296);
			...
			this.dateTimePickerBoughtDate.TabIndex = 3;
			...
			this.comboBoxCopyStatus.TabIndex = 5;
			...
			this.textBoxShelfCode.TabIndex = 6;
			...
			this.textBoxStoreCode.TabIndex = 7;
			...
			this.textBoxCurrRate.TabIndex = 9;
			...
			this.textBoxStatusDesc.TabIndex = 12;
			...
			this.comboBoxBookStatus.TabIndex = 11;
			...
			this.textBoxBarCodeNo.Location = new System.Drawing.Point(384, 328);
			...
			this.label1.Location = new System.Drawing.Point(256, 328);
		...
		private void textBoxCopyNo_TextChanged(object sender, System.EventArgs e)
		{
			...
			textBoxBarCodeNo.Text = textBoxBookCode.Text.ToString().Trim() + "C" + textBoxCopyNo.Text.ToString();
		}
		...
		private void buttonEdit_Click(object sender, System.EventArgs e)
		{
			...
			textBoxBarCodeNo.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,1].ToString().Trim();
			dateTimePickerBoughtDate.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,2].ToString().Trim();
			comboBoxCopyType.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,3].ToString().Trim();
			comboBoxCopyStatus.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,4].ToString().Trim();
			textBoxShelfCode.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,5].ToString().Trim();
			textBoxStoreCode.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,7].ToString().Trim();
			textBoxCurr.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,9].ToString().Trim();
			textBoxCurrRate.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,10].ToString().Trim();
			textBoxPrice.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,11].ToString().Trim();
			comboBoxBookStatus.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,12].ToString().Trim();
			textBoxStatusDesc.Text = dataGridBookCopy[dataGridBookCopy.CurrentRowIndex,13].ToString().Trim();
		...
		{
			MyBookExemplar.BarCodeNo = textBoxBarCodeNo.Text.ToString();
		}
	}
}
