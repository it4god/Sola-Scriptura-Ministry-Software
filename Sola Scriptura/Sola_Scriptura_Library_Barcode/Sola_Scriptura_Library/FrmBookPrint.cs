...
namespace Sola_Scriptura_Library
{
	public class FrmBookPrint : Sola_Scriptura_Library.FrmFormParent
	{
		...
		private System.Windows.Forms.TextBox textBoxMySQL;
		internal System.Windows.Forms.Button buttonGenerateSQL;
		...
		private void InitializeComponent()
		{
			...
			this.textBoxMySQL = new System.Windows.Forms.TextBox();
			...
			this.dataGridBookPrint.Size = new System.Drawing.Size(672, 200);
			...
			this.dataGridTextBoxColumnBookCode.Width = 75;
			// 
			...
			this.dataGridTextBoxColumnFirstName.Width = 75;
			// 
			...
			this.buttonPrint.Location = new System.Drawing.Point(832, 408);
			...
			// textBoxMySQL
			// 
			this.textBoxMySQL.Location = new System.Drawing.Point(248, 408);
			this.textBoxMySQL.Multiline = true;
			this.textBoxMySQL.Name = "textBoxMySQL";
			this.textBoxMySQL.Size = new System.Drawing.Size(472, 112);
			this.textBoxMySQL.TabIndex = 214;
			this.textBoxMySQL.Text = "";
			// 
			// buttonGenerateSQL
			// 
			this.buttonGenerateSQL.Font = new System.Drawing.Font("Microsoft Sans Serif", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.buttonGenerateSQL.ForeColor = System.Drawing.SystemColors.HighlightText;
			this.buttonGenerateSQL.Image = ((System.Drawing.Image)(resources.GetObject("buttonGenerateSQL.Image")));
			this.buttonGenerateSQL.Location = new System.Drawing.Point(728, 488);
			this.buttonGenerateSQL.Name = "buttonGenerateSQL";
			this.buttonGenerateSQL.Size = new System.Drawing.Size(88, 32);
			this.buttonGenerateSQL.TabIndex = 215;
			this.buttonGenerateSQL.Text = "SQL";
			...
			this.Controls.Add(this.textBoxMySQL);
			...
			this.Controls.SetChildIndex(this.textBoxMySQL, 0);
			this.Controls.SetChildIndex(this.buttonGenerateSQL, 0);
		...
		private void buttonGenerateSQL_Click(object sender, System.EventArgs e)
		{
			MyClassDatabase = new ClassDatabase();
			textBoxMySQL.Text = MyClassDatabase.mySQL();
		}
	}
}
