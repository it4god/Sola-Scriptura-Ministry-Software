...
namespace Sola_Scriptura_Library
{
	...
	public class FrmSearchMiniForm : System.Windows.Forms.Form
	{
		...
		internal System.Windows.Forms.DataGridTableStyle dataGridTableStyleCutterMs;
		...
		public FrmSearchMiniForm(FrmBookMsDetail BookMsDetailForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = BookMsDetailForm.MyMDIForm;
			MyBookMsDetailForm = BookMsDetailForm;
			MyCurrentData = CurrentData;
		}
		public FrmSearchMiniForm(FrmBookMsAuthor BookMsAuthorForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = BookMsAuthorForm.MyMDIForm;
			MyBookMsAuthorForm = BookMsAuthorForm;
			MyCurrentData = CurrentData;
		}
		public FrmSearchMiniForm(FrmBookMsCopy BookMsCopyForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = BookMsCopyForm.MyMDIForm;
			MyBookMsCopyForm = BookMsCopyForm;
			MyCurrentData = CurrentData;
		}
		public FrmSearchMiniForm(FrmBookMsSubject BookMsSubjectForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = BookMsSubjectForm.MyMDIForm;
			MyBookMsSubjectForm = BookMsSubjectForm;
			MyCurrentData = CurrentData;
		}
		public FrmSearchMiniForm(FrmTransactionBorrow TransactionBorrowForm, string CurrentData)
		{
		...
		public FrmSearchMiniForm(FrmTransactionReturn TransactionReturnForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = TransactionReturnForm.MyMDIForm;
			MyTransactionReturnForm = TransactionReturnForm;
			MyCurrentData = CurrentData;
		}
		public FrmSearchMiniForm(FrmMemberHistory MemberHistoryForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = MemberHistoryForm.MyMDIForm;
			MyMemberHistoryForm = MemberHistoryForm;
			MyCurrentData = CurrentData;
		}
		public FrmSearchMiniForm(FrmBookOutstanding BookOutstandingForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = BookOutstandingForm.MyMDIForm;
			MyBookOutstandingForm = BookOutstandingForm;
			MyCurrentData = CurrentData;
		}
		public FrmSearchMiniForm(FrmBookHistory BookHistoryForm, string CurrentData)
		{

			InitializeComponent();
			this.MdiParent = BookHistoryForm.MyMDIForm;
			MyBookHistoryForm = BookHistoryForm;
			MyCurrentData = CurrentData;
		}
		///
		///
		...
		private void InitializeComponent()
		{
			...
			this.dataGridTableStyleCutterMs = new System.Windows.Forms.DataGridTableStyle();
			...
			this.dataGridSearch.TableStyles.AddRange(new System.Windows.Forms.DataGridTableStyle[] {
																									   ...
																									   this.dataGridTableStyleCutterMs});
			...
			// 
			// dataGridTableStyleCutterMs
			// 
			this.dataGridTableStyleCutterMs.AlternatingBackColor = System.Drawing.Color.FromArgb(((System.Byte)(27)), ((System.Byte)(64)), ((System.Byte)(166)));
			this.dataGridTableStyleCutterMs.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(86)), ((System.Byte)(127)), ((System.Byte)(220)));
			this.dataGridTableStyleCutterMs.DataGrid = this.dataGridSearch;
			this.dataGridTableStyleCutterMs.ForeColor = System.Drawing.SystemColors.HighlightText;
			this.dataGridTableStyleCutterMs.GridLineColor = System.Drawing.SystemColors.ControlLightLight;
			this.dataGridTableStyleCutterMs.HeaderBackColor = System.Drawing.Color.FromArgb(((System.Byte)(27)), ((System.Byte)(64)), ((System.Byte)(166)));
			this.dataGridTableStyleCutterMs.HeaderForeColor = System.Drawing.SystemColors.HighlightText;
			this.dataGridTableStyleCutterMs.MappingName = "CutterMs";
			// 
			// FrmSearchMiniForm
			// 
		...
		{
			MyCriteria = "";
			if(MyCurrentData == "BookGroup")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetBookGroup();
				MyDataView = new DataView(MyDataTable, "BookGroupCode LIKE '%" + MyCriteria + "%' or GroupName LIKE '%" + MyCriteria + "%' ", "BookGroupCode", DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Book Group";
			}
			else if(MyCurrentData == "Publisher")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetPublisherList();
				MyDataView = new DataView(MyDataTable, "PublisherCode LIKE '%" + MyCriteria + "%' or PublisherName LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or Fax LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%' or ContactPerson LIKE '%" + MyCriteria + "%'", "PublisherCode", DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Publisher";
			}
			else if(MyCurrentData == "BookAuthor")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetAuthorList();
				MyDataView = new DataView(MyDataTable, "AuthorCode LIKE '%" + MyCriteria + "%' or FirstName LIKE '%" + MyCriteria + "%' or LastName LIKE '%" + MyCriteria + "%' ","AuthorCode",DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Author";
			}
			else if(MyCurrentData == "AuthorType")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetAuthorType();
				MyDataView = new DataView(MyDataTable, "AuthorType LIKE '%" + MyCriteria + "%'" ,"AuthorType",DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Author Type";
			}
			else if(MyCurrentData == "ShelfCode")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetShelfList();
				MyDataView = new DataView(MyDataTable, "ShelfCode LIKE '%" + MyCriteria + "%' or ShelfDesc LIKE '%" + MyCriteria + "%' or LocationCode LIKE '%" + MyCriteria + "%' or LocationName LIKE '%" + MyCriteria + "%' " ,"ShelfCode",DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Book Shelf";
			}
			else if(MyCurrentData == "StoreCode")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetBookStoreList();
				MyDataView = new DataView(MyDataTable, "StoreCode LIKE '%" + MyCriteria + "%' or StoreName LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or Fax LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%' or ContactPerson LIKE '%" + MyCriteria + "%'" ,"StoreCode",DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "BookStore";
			}
			else if(MyCurrentData == "Currency")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetCurrencyList();
				MyDataView = new DataView(MyDataTable, "Curr LIKE '%" + MyCriteria + "%' or CurrName LIKE '%" + MyCriteria + "%' " ,"Curr",DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Currency";
			}
			else if(MyCurrentData == "BookSubject")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetSubjectList();
				MyDataView = new DataView(MyDataTable, "SubjectCode LIKE '%" + MyCriteria + "%' or SubjectName LIKE '%" + MyCriteria + "%'" ,"SubjectCode",DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Subject";
			}
			else if(MyCurrentData == "Member")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetMember(new Member());
				MyDataView = new DataView(MyDataTable, "MemberID LIKE '%" + MyCriteria + "%' or MemberName LIKE '%" + MyCriteria + "%' or ActiveDate LIKE '%" + MyCriteria + "%' or MemberGroupCode LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or HandPhone LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%'", "MemberID", DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Member";
			}
			else if(MyCurrentData == "Member2")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetMember(new Member());
				MyDataView = new DataView(MyDataTable, "MemberID LIKE '%" + MyCriteria + "%' or MemberName LIKE '%" + MyCriteria + "%' or ActiveDate LIKE '%" + MyCriteria + "%' or MemberGroupCode LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or HandPhone LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%'", "MemberID", DataViewRowState.CurrentRows);
			...
			else if(MyCurrentData == "MemberHistory")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetMember(new Member());
				MyDataView = new DataView(MyDataTable, "MemberID LIKE '%" + MyCriteria + "%' or MemberName LIKE '%" + MyCriteria + "%' or ActiveDate LIKE '%" + MyCriteria + "%' or MemberGroupCode LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or HandPhone LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%'", "MemberID", DataViewRowState.CurrentRows);
			...
			else if(MyCurrentData == "BookOutstandingBorrowDate")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetBookOutstanding();
				MyDataView = new DataView(MyDataTable,"","BorrowDate",DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Borrow Date";
			}
			else if(MyCurrentData == "BookOutstandingMember")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetMember(new Member());
				MyDataView = new DataView(MyDataTable, "MemberID LIKE '%" + MyCriteria + "%' or MemberName LIKE '%" + MyCriteria + "%' or ActiveDate LIKE '%" + MyCriteria + "%' or MemberGroupCode LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or HandPhone LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%'", "MemberID", DataViewRowState.CurrentRows);
			...
			else if(MyCurrentData == "BookHistory")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetMember(new Member());
				MyDataView = new DataView(MyDataTable, "MemberID LIKE '%" + MyCriteria + "%' or MemberName LIKE '%" + MyCriteria + "%' or ActiveDate LIKE '%" + MyCriteria + "%' or MemberGroupCode LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or HandPhone LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%'", "MemberID", DataViewRowState.CurrentRows);
			...
			else if(MyCurrentData == "BookCutterMs")
			{
				MyClassDatabase = new ClassDatabase();
				MyDataTable = MyClassDatabase.GetCutterMs();
				MyDataView =  new DataView(MyDataTable, "CutterCode LIKE '%" + MyCriteria + "%'", "CutterCode", DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
				LabelTitle.Text = "Member";
			}
		...
		private void dataGridSearch_DoubleClick(object sender, System.EventArgs e)
		{
			if(MyCurrentData == "BookGroup")
			{
				MyBookMsDetailForm.textBoxBookGroupCode.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyBookMsDetailForm.textBoxBookGroupName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "Publisher")
			{
				MyBookMsDetailForm.textBoxPublisherCode.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyBookMsDetailForm.textBoxPublisherName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "BookAuthor")
			{
				MyBookMsAuthorForm.textBoxAuthorCode.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyBookMsAuthorForm.textBoxAuthorName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim() + " " + dataGridSearch[dataGridSearch.CurrentRowIndex,2].ToString().Trim();;
				this.Dispose();
			}
			else if(MyCurrentData == "AuthorType")
			{
				MyBookMsAuthorForm.textBoxAuthorType.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "ShelfCode")
			{
				MyBookMsCopyForm.textBoxShelfCode.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "StoreCode")
			{
				MyBookMsCopyForm.textBoxStoreCode.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "Currency")
			{
				MyBookMsCopyForm.textBoxCurr.Text =  dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "BookSubject")
			{
				MyBookMsSubjectForm.textBoxSubjectCode.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyBookMsSubjectForm.textBoxSubjectName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "Member")
			{
				MyTransactionBorrowForm.textBoxMemberID.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyTransactionBorrowForm.textBoxMemberName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				MyTransactionBorrowForm.MyClassDatabase = new ClassDatabase();
				MyTransactionBorrowForm.MyDataTable = MyTransactionBorrowForm.MyClassDatabase.GetTransactionBorrow(MyTransactionBorrowForm.textBoxMemberID.Text.ToString());
				MyTransactionBorrowForm.dataGridBorrow.DataSource = MyTransactionBorrowForm.MyDataTable;
				MyTransactionBorrowForm.MyBookTransaction.MemberID = MyTransactionBorrowForm.textBoxMemberID.Text.ToString();
				MyTransactionBorrowForm.textBoxMemberName.Text = MyTransactionBorrowForm.MyClassDatabase.GetMemberName(MyTransactionBorrowForm.textBoxMemberID.Text.ToString());
				MyTransactionBorrowForm.RefreshButton();
				this.Dispose();
			}
			else if(MyCurrentData == "Member2")
			{
				MyTransactionReturnForm.textBoxMemberID.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyTransactionReturnForm.textBoxMemberName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "MemberHistory")
			{
				MyMemberHistoryForm.textBoxMemberID.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyMemberHistoryForm.textBoxMemberName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "BookOutstandingBorrowDate")
			{
				MyBookOutstandingForm.textBoxBorrowDate.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "BookOutstandingMember")
			{
				MyBookOutstandingForm.textBoxMemberID.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyBookOutstandingForm.textBoxMemberName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "BookHistory")
			{
				MyBookHistoryForm.textBoxMemberID.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,0].ToString().Trim();
				MyBookHistoryForm.textBoxMemberName.Text = dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
			else if(MyCurrentData == "BookCutterMs")
			{
				MyBookMsDetailForm.textBoxDDC.Text = MyBookMsDetailForm.textBoxDDC.Text + " " + dataGridSearch[dataGridSearch.CurrentRowIndex,1].ToString().Trim();
				this.Dispose();
			}
		}
		...
		private void textBoxSearch_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				MyDataView = new DataView(MyDataTable, "MemberID LIKE '%" + MyCriteria + "%' or MemberName LIKE '%" + MyCriteria + "%' or MemberGroupCode LIKE '%" + MyCriteria + "%' or Address LIKE '%" + MyCriteria + "%' or City LIKE '%" + MyCriteria + "%' or PostCode LIKE '%" + MyCriteria + "%' or State LIKE '%" + MyCriteria + "%' or Country LIKE '%" + MyCriteria + "%' or Phone LIKE '%" + MyCriteria + "%' or HandPhone LIKE '%" + MyCriteria + "%' or Email LIKE '%" + MyCriteria + "%'", "MemberID", DataViewRowState.CurrentRows);
				dataGridSearch.DataSource = MyDataView;
			}
			else if(MyCurrentData == "Member2")
			{
