...
namespace Sola_Scriptura_Library
{
	public class FrmTransactionReturn : Sola_Scriptura_Library.FrmFormParent
	{
		...
		private void InitializeComponent()
		{
			...
			// textBoxBarCodeNo
			// 
			this.textBoxBarCodeNo.BackColor = System.Drawing.Color.FromArgb(((System.Byte)(27)), ((System.Byte)(64)), ((System.Byte)(166)));
			...
			this.textBoxBarCodeNo.ForeColor = System.Drawing.SystemColors.HighlightText;
			this.textBoxBarCodeNo.Location = new System.Drawing.Point(384, 416);
			this.textBoxBarCodeNo.Name = "textBoxBarCodeNo";
			this.textBoxBarCodeNo.ReadOnly = true;
			this.textBoxBarCodeNo.Size = new System.Drawing.Size(200, 22);
			this.textBoxBarCodeNo.TabIndex = 204;
			this.textBoxBarCodeNo.TabStop = false;
			...
			this.labelBarCodeNo.Location = new System.Drawing.Point(256, 416);
			this.labelBarCodeNo.Name = "labelBarCodeNo";
			this.labelBarCodeNo.Size = new System.Drawing.Size(120, 24);
			this.labelBarCodeNo.TabIndex = 206;
			this.labelBarCodeNo.Text = "Bar Code No";
			// 
			// label1
			// 
			...
			this.buttonSearchMember.TabIndex = 216;
		...
		private void buttonEdit_Click(object sender, System.EventArgs e)
		{
			...
			textBoxBarCodeNo.Text = dataGridReturn[dataGridReturn.CurrentRowIndex,3].ToString().Trim();
			textBoxBookName.Text = dataGridReturn[dataGridReturn.CurrentRowIndex,4].ToString().Trim();
			
			System.TimeSpan DateDiff;
			DateDiff = Convert.ToDateTime(dateTimePickerActualReturnDate.Text.ToString())-Convert.ToDateTime(dataGridReturn[dataGridReturn.CurrentRowIndex,5].ToString().Trim());
			int DayDiff = DateDiff.Days;
			if(DayDiff > 0)
			{
				textBoxFine.Text = Convert.ToDecimal(MyMDIForm.MyFine * Convert.ToDecimal(DayDiff)).ToString();
		...
		{
			MyBookTransaction.BarCodeNo = textBoxBarCodeNo.Text.ToString().Trim();
		}
