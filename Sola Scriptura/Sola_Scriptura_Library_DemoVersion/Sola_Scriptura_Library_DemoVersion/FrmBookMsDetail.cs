...
namespace Sola_Scriptura_Library
{
	public class FrmBookMsDetail : Sola_Scriptura_Library.FrmBookMaster
	{
		...
		private void buttonSave_Click(object sender, System.EventArgs e)
		{
			...
			else if(MyClassDatabase.ExceedBook() == "ERROR")
			{
				MessageBox.Show("In this Demo Version, you can add to 25 books only","Information");
			}
			else
			{
				...
				MessageBox.Show("Save Success ! Please add Book Exemplar for transactions... ", "Information");
		...
		private void buttonAuto_Click(object sender, System.EventArgs e)
		{
			if(StatusAction == "Add")
			{
				...
				BookCode = comboBoxLanguage.Text.ToString().Substring(0,1).ToString();
