...
namespace Sola_Scriptura_Library
{
	...
	public class ClassDatabase
	{
		...
		public ClassDatabase()
		{
            ...
            string ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + AppPath + "SolaScripturaDatabase.mdb";
		...
		public string LoginNow(string UserName, string UserPassword)
		{
			...
			try
			{
				...
				{
					MyDataReader.Read();
					MyLogin = MyDataReader.GetString(4);
					MyConnection.Close();
					return MyLogin;
				}
				else
		...
		public string ExceedTransactions()
		{

			try
			{
				MyConnection.Open();
				strSQL = "SELECT COUNT(*) From BookTransaction";
				MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
				MyDataReader = MyOleDbCommand.ExecuteReader ();
				if (MyDataReader.HasRows == true)
				{
		...
		public string GetMaxAuthorCode()
		{
			...
			if(MyDataReader.GetInt32(0) >0)
			{
				MyConnection.Close();
				MyConnection.Open();
				strSQL = "SELECT MAX(AuthorCode) From Author";
				MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
				MyDataReader = MyOleDbCommand.ExecuteReader ();
				MyDataReader.Read();
				return MyDataReader.GetString(0);
		...
		public DataTable GetDDCList(string Type)
		{
			...
			{
				if (Type=="Ten")
					strSQL = "SELECT * From DDCMaster WHERE DDCCode mod 100 = 0";		
				else if (Type=="Hundred")
					strSQL = "SELECT * From DDCMaster WHERE DDCCode mod 100 <> 0 and DDCCode mod 10 =0";
		...
		public string GetMaxStoreCode()
		{
			...
			if(MyDataReader.GetInt32(0) >0)
			{
				MyConnection.Close();
				MyConnection.Open();
				strSQL = "SELECT MAX(StoreCode) From BookStore";
				MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
				MyDataReader = MyOleDbCommand.ExecuteReader ();
				MyDataReader.Read();
				return MyDataReader.GetString(0);
		...
		public DataTable GetCurrencyList()
		{
			try
			{
				strSQL = "SELECT * From CurrencyList ORDER BY 1";		
				MyDataAdapter = new OleDbDataAdapter(strSQL,MyConnection);
		...
		public void SaveCurrency(Currency MyCurrency)
		{
			...
			{
				MyConnection.Open();
				strSQL = "SELECT * From CurrencyList WHERE Curr = '" + (MyCurrency.Curr.ToString()) + "' ";
				MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
				MyDataReader = MyOleDbCommand.ExecuteReader ();
				bool HasRow;
				if (MyDataReader.HasRows == true)
		...
		public string GetMaxBookCode(string Language)
		{
			...
			MyConnection.Open();
			strSQL = "SELECT COUNT(BookCode) From Book WHERE BookCode LIKE '" + Language +  DateTime.Now.Year.ToString().Substring(2,2) + "%'";
			MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
			MyDataReader = MyOleDbCommand.ExecuteReader ();
			MyDataReader.Read();
			if(MyDataReader.GetInt32(0) >0)
			{
				MyConnection.Close();
				MyConnection.Open();
				strSQL = "SELECT MAX(BookCode) From Book WHERE BookCode LIKE '" + Language + DateTime.Now.Year.ToString().Substring(2,2) + "%'";
				MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
				MyDataReader = MyOleDbCommand.ExecuteReader ();
				MyDataReader.Read();
				return MyDataReader.GetString(0);
			...
			{
				return Language + DateTime.Now.Year.ToString().Substring(2,2).ToString() + "0000000";
			}
		...
		public bool GetCheckImageData(string BookCode)
		{
			...
			MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
			MyDataReader = MyOleDbCommand.ExecuteReader(CommandBehavior.SequentialAccess);
			MyDataReader.Read();
		...
		public void SaveTransactionBorrow(BookTransaction MyBookTransaction)
		{
			try
			{
				...
				if(MyBookTransaction.BorrowSeq!="")
				{
					...
					strSQL = "UPDATE BookTransaction SET BorrowDate = '" + DateTimeBorrowDate + "' ,BookCode = '" + MyBookTransaction.BookCode.ToString() + "' , CopyNo = '" + MyBookTransaction.CopyNo.ToString() + "' ,ReturnDate = '" + DateTimeReturnDate + "' ,LibrarianBorrow = '" + MyBookTransaction.LibrarianBorrow.ToString() + "' ,UpdateUser = '" + MyBookTransaction.UpdateUser.ToString() + "' ,UpdateDate = '" + DateTimeNow + "' WHERE BorrowDate = #" + DateTimePreviousBorrowDate + "# and MemberID = '" + MyBookTransaction.MemberID.ToString() + "' and BorrowSeq = " + MyBookTransaction.BorrowSeq.ToString() + " ";
					MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
					MyOleDbCommand.ExecuteNonQuery();
					MyConnection.Close();
					MyConnection.Open();
					strSQL = "UPDATE BookExemplar SET BorrowBy = '' WHERE BookCode = '" + MyBookTransaction.PreviousBookCode.ToString() + "' and CopyNo = '" + MyBookTransaction.PreviousCopyNo.ToString() + "' ";
				...
				else
				{
					...
					MyDataRow["BookCode"] = MyBookTransaction.BookCode.ToString();
					MyDataRow["CopyNo"] = MyBookTransaction.CopyNo.ToString();
		...
		public void SaveTransactionReturn(BookTransaction MyBookTransaction)
		{
			try
			{
				...
				MyConnection.Close();
				MyConnection.Open();
				strSQL = "UPDATE BookExemplar SET BorrowBy = '', CopyStatus = '1' WHERE BookCode = '" + MyBookTransaction.BookCode.ToString() + "' and CopyNo = '" + MyBookTransaction.CopyNo.ToString() + "' ";
		...
		public DataTable GetTotalTitle()
		{
			...
			try
			{
				strSQL = "SELECT DISTINCT (SELECT COUNT(BookCode)FROM Book WHERE BookCode LIKE 'E%') AS Total_English_Title, (SELECT COUNT(BookCode) FROM Book WHERE BookCode LIKE 'I%') AS Total_Indonesian_Title, (SELECT COUNT(BookCode) FROM Book WHERE BookCode LIKE 'C%') AS Total_Chinese_Title, (SELECT COUNT(BookCode) FROM Book WHERE BookCode NOT LIKE 'I%'AND BookCOde NOT LIKE 'E%' AND BookCode NOT LIKE 'C%' ) AS Total_Other_Title , (SELECT COUNT(BookCode) FROM Book ) AS Total_Title  FROM Book"; 
				MyDataAdapter = new OleDbDataAdapter(strSQL,MyConnection);
		...
		public DataTable GetTotalExemplar()
		{
			...
			try
			{
				strSQL = "SELECT DISTINCT (SELECT COUNT(BookCode)FROM BookExemplar WHERE BookCode LIKE 'E%') AS Total_English_Exemplar, (SELECT COUNT(BookCode) FROM BookExemplar WHERE BookCode LIKE 'I%') AS Total_Indonesian_Exemplar, (SELECT COUNT(BookCode) FROM BookExemplar WHERE BookCode LIKE 'C%') AS Total_Chinese_Exemplar, (SELECT COUNT(BookCode) FROM BookExemplar WHERE BookCode NOT LIKE 'I%'AND BookCOde NOT LIKE 'E%' AND BookCode NOT LIKE 'C%') AS Total_Other_Exemplar , (SELECT COUNT(BookCode) FROM BookExemplar ) AS Total_Exemplar, (SELECT COUNT(BookCode) From BookExemplar WHERE CopyStatus ='1') As Available, (SELECT COUNT(BookCode) From BookExemplar WHERE CopyStatus = '2') AS Out, (SELECT COUNT(BookCode) From BookExemplar WHERE CopyStatus = '3') AS Broken, (SELECT COUNT(BookCode) From BookExemplar WHERE CopyStatus ='4') AS Lost  FROM BookExemplar"; 
				MyDataAdapter = new OleDbDataAdapter(strSQL,MyConnection);
		...
		public string GetJournalID(string Head, string Language)
		{
			try
			{
				...
				if(MyDataReader.HasRows== true)
				{
					...
					{
						MyJournalID = Head + "0" + MyIntJournalID.ToString() + Language;
					}
					else
					{
