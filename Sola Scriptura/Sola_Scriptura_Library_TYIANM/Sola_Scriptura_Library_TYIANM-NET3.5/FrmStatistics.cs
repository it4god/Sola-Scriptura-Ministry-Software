...
namespace Sola_Scriptura_Library
{
	public class FrmStatistics : Sola_Scriptura_Library.FrmFormParent
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridTextBoxColumn5.HeaderText = "Total_English_Exemplar";
			this.dataGridTextBoxColumn5.MappingName = "Total_English_Exemplar";
			...
			this.dataGridTextBoxColumn6.HeaderText = "Total_Indonesian_Exemplar";
			this.dataGridTextBoxColumn6.MappingName = "Total_Indonesian_Exemplar";
			...
			this.dataGridTextBoxColumn14.HeaderText = "Total_Chinese_Exemplar";
			this.dataGridTextBoxColumn14.MappingName = "Total_Chinese_Exemplar";
			...
			this.dataGridTextBoxColumn7.HeaderText = "Total_Other_Exemplar";
			this.dataGridTextBoxColumn7.MappingName = "Total_Other_Exemplar";
			...
			this.dataGridTextBoxColumn1.HeaderText = "Total_English_Title";
			this.dataGridTextBoxColumn1.MappingName = "Total_English_Title";
			...
			this.dataGridTextBoxColumn2.HeaderText = "Total_Indonesian_Title";
			this.dataGridTextBoxColumn2.MappingName = "Total_Indonesian_Title";
			...
			this.dataGridTextBoxColumn13.HeaderText = "Total_Chinese_Title";
			this.dataGridTextBoxColumn13.MappingName = "Total_Chinese_Title";
			...
			this.dataGridTextBoxColumn3.HeaderText = "Total_Other_Title";
			this.dataGridTextBoxColumn3.MappingName = "Total_Other_Title";
