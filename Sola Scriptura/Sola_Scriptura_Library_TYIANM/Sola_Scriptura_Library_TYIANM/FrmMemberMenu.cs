...
{
	public class FrmMemberMenu : Sola_Scriptura_Library.FrmBigMenu
	{
		...
		internal System.Windows.Forms.Label labelMemberHistory;
		internal System.Windows.Forms.PictureBox pictureBoxMemberHistory;
		...
		private void InitializeComponent()
		{
			...
			this.labelMemberHistory = new System.Windows.Forms.Label();
			this.pictureBoxMemberHistory = new System.Windows.Forms.PictureBox();
			this.SuspendLayout();
			// 
			// labelData
			// 
			...
			// labelMemberHistory
			// 
			this.labelMemberHistory.Font = new System.Drawing.Font("Verdana", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			this.labelMemberHistory.ForeColor = System.Drawing.SystemColors.HighlightText;
			this.labelMemberHistory.Image = ((System.Drawing.Image)(resources.GetObject("labelMemberHistory.Image")));
			this.labelMemberHistory.Location = new System.Drawing.Point(480, 402);
			this.labelMemberHistory.Name = "labelMemberHistory";
			this.labelMemberHistory.Size = new System.Drawing.Size(120, 16);
			this.labelMemberHistory.TabIndex = 68;
			this.labelMemberHistory.Text = "Member History";
			this.labelMemberHistory.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.labelMemberHistory.Click += new System.EventHandler(this.labelMemberHistory_Click);
			// 
			// pictureBoxMemberHistory
			// 
			this.pictureBoxMemberHistory.Image = ((System.Drawing.Image)(resources.GetObject("pictureBoxMemberHistory.Image")));
			this.pictureBoxMemberHistory.Location = new System.Drawing.Point(400, 384);
			this.pictureBoxMemberHistory.Name = "pictureBoxMemberHistory";
			this.pictureBoxMemberHistory.Size = new System.Drawing.Size(224, 58);
			this.pictureBoxMemberHistory.SizeMode = System.Windows.Forms.PictureBoxSizeMode.AutoSize;
			this.pictureBoxMemberHistory.TabIndex = 67;
			this.pictureBoxMemberHistory.TabStop = false;
			// 
			// FrmMemberMenu
			// 
			this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
			this.ClientSize = new System.Drawing.Size(1020, 570);
			this.Controls.Add(this.labelMemberHistory);
			this.Controls.Add(this.pictureBoxMemberHistory);
			...
			this.Controls.SetChildIndex(this.pictureBoxMemberHistory, 0);
			this.Controls.SetChildIndex(this.labelMemberHistory, 0);
		...
		private void labelAdd_Click(object sender, System.EventArgs e)
		{
			...
			MyMemberForm.MyMember.UpdateUser = base.MyMDIForm.LibrarianUserName.ToString();
			MyMemberForm.comboBoxMemberGroupCode.Text = "Student";
			//MyMemberForm.DoUnlock();
		...
		private void labelEdit_Click(object sender, System.EventArgs e)
		{
			...
			MyModifyMemberForm.MyMember.UpdateUser = base.MyMDIForm.LibrarianUserName.ToString();
