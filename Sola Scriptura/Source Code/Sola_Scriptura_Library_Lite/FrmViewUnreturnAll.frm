...
Begin VB.Form FrmViewUnreturnAll 
   AutoRedraw      =   -1  'True
   BackColor       =   &H80000005&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "View Unreturned All"
   ClientHeight    =   7170
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9135
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "FrmViewUnreturnAll.frx":0000
      Height          =   5655
      Left            =   120
      TabIndex        =   0
      Top             =   840
   ...
   Begin MSAdodcLib.Adodc Adodc3 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"FrmViewUnreturnAll.frx":0015
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   9.75
   ...
   Begin MSAdodcLib.Adodc Adodc2 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"FrmViewUnreturnAll.frx":0040
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   9.75
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"FrmViewUnreturnAll.frx":006B
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   9.75
   ...
   Begin VB.Image Image1 
      Height          =   7170
      Left            =   0
      Picture         =   "FrmViewUnreturnAll.frx":0096
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9135
   End
   ...
   End
End
Attribute VB_Name = "FrmViewUnreturnAll"
...
If Mid(DataGrid1.Columns(0).Value, 2, 1) = "B" Then
    Adodc2.RecordSource = "SELECT * From Lending_Books WHERE BorrowerID = " & Val(DataGrid1.Columns(2).Value) & " and ItemNo = '" & DataGrid1.Columns(0).Value & "' and (AvailID = 'B' or AvailID = 'E') and ReturnDate = #" & CDate(DataGrid1.Columns(9).Value) & "#"
    Adodc3.RecordSource = "SELECT * From Books Where ItemNo = '" & DataGrid1.Columns(0).Value & "'"
ElseIf Mid(DataGrid1.Columns(0).Value, 2, 1) = "K" Then
    Adodc2.RecordSource = "SELECT * From Lending_Cassettes WHERE BorrowerID = " & Val(DataGrid1.Columns(2).Value) & " and ItemNo = '" & DataGrid1.Columns(0).Value & "' and (AvailID = 'B' or AvailID = 'E')and ReturnDate = #" & CDate(DataGrid1.Columns(9).Value) & "#"
    Adodc3.RecordSource = "SELECT * From Cassettes Where ItemNo = '" & DataGrid1.Columns(0).Value & "'"
ElseIf Mid(DataGrid1.Columns(0).Value, 2, 1) = "C" Then
    Adodc2.RecordSource = "SELECT * From Lending_CDs WHERE BorrowerID = " & Val(DataGrid1.Columns(2).Value) & " and ItemNo = '" & DataGrid1.Columns(0).Value & "' and (AvailID = 'B' or AvailID = 'E') and ReturnDate = #" & CDate(DataGrid1.Columns(9).Value) & "#"
    Adodc3.RecordSource = "SELECT * From CDs Where ItemNo = '" & DataGrid1.Columns(0).Value & "'"
ElseIf Mid(DataGrid1.Columns(0).Value, 2, 1) = "V" Then
    Adodc2.RecordSource = "SELECT * From Lending_Videos WHERE BorrowerID = " & Val(DataGrid1.Columns(2).Value) & " and ItemNo = '" & DataGrid1.Columns(0).Value & "' and (AvailID = 'B' or AvailID = 'E') and ReturnDate = #" & CDate(DataGrid1.Columns(9).Value) & "#"
    Adodc3.RecordSource = "SELECT * From Videos Where ItemNo = '" & DataGrid1.Columns(0).Value & "'"
Else
    MsgBox "The ID is not valid ID", vbInformation, "Error"
    Exit Sub
