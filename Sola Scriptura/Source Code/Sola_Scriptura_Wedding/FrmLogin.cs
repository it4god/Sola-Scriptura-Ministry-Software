...
namespace Sola_Scriptura_Wedding
{
	...
	public class FrmLogin : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.PictureBox1.Location = new System.Drawing.Point(576, 252);
			...
			this.label2.Text = "Sola Scriptura Wedding  Program";
			// 
			// pictureBox7
			// 
			...
			this.label3.Location = new System.Drawing.Point(236, 336);
			this.label3.Name = "label3";
			this.label3.Size = new System.Drawing.Size(220, 24);
			this.label3.TabIndex = 19;
			this.label3.Text = "Wedding Program";
			// 
			// label4
			// 
			...
			this.label4.Text = "Charity Editon - Version 1.0";
			// 
			// FrmLogin
			// 
		...
		{	
			...
			MyMP3Player.Open(AppPath + "music\\spring.mp3");
			MyMP3Player.Play();
		}
