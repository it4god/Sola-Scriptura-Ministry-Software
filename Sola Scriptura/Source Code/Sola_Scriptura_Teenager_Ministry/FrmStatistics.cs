...
{
	public class FrmStatistics : Teenager_Ministry.FrmFormParent
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelRemark.Location = new System.Drawing.Point(240, 112);
			this.labelRemark.Name = "labelRemark";
			this.labelRemark.Size = new System.Drawing.Size(120, 24);
			this.labelRemark.TabIndex = 230;
		...
		private void buttonPrint_Click(object sender, System.EventArgs e)
		{
			...
			MyDataTable = MyClassDatabase.GetChart(dateTimePicker1.Value.ToShortDateString(), dateTimePicker2.Value.ToShortDateString(), comboBoxRemark.Text.ToString());
