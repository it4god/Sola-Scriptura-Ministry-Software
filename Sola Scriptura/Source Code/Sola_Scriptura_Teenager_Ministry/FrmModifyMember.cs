...
{
	public class FrmModifyMember : Teenager_Ministry.FrmFormParent
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridTextBoxColumnParentEmail.HeaderText = "ParentEmail";
		...
		private void buttonModify_Click(object sender, System.EventArgs e)
		{
			if(buttonModify.Text.ToString()=="Edit") 
			{
				...
				MyMemberForm.textBoxPlaceBirthDate.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,2].ToString().Trim();
				MyMemberForm.textBoxAddress.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,3].ToString().Trim();
				MyMemberForm.textBoxRegion.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,4].ToString().Trim();
				MyMemberForm.textBoxPostCode.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,5].ToString().Trim();	
				MyMemberForm.textBoxPhone.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,6].ToString().Trim();
				MyMemberForm.textBoxHandPhone.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,7].ToString().Trim();
				MyMemberForm.textBoxEmail.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,8].ToString().Trim();
				MyMemberForm.textBoxParentEmail.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,9].ToString().Trim();
				MyMemberForm.textBoxFatherName.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,10].ToString().Trim();
				MyMemberForm.textBoxMotherName.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,11].ToString().Trim();
				MyMemberForm.textBoxParentHP.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,12].ToString().Trim();
				MyMemberForm.comboBoxIsBaptized.Text  = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,13].ToString().Trim();
				MyMemberForm.textBoxInChurch.Text  = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,14].ToString().Trim();
				MyMemberForm.comboBoxStatus.Text  = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,15].ToString().Trim();
				MyMemberForm.comboBoxRemark.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,16].ToString().Trim();
				MyMemberForm.textBoxTalents.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,17].ToString().Trim();
				MyMemberForm.textBoxHobbies.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,18].ToString().Trim();
				MyMemberForm.textBoxPhotoPath.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,19].ToString().Trim();
