...
{
	public class FrmCheckAttendance : Teenager_Ministry.FrmFormParent
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelTotal1.Size = new System.Drawing.Size(296, 24);
			...
			this.labelTotal2.Size = new System.Drawing.Size(304, 24);
			...
			this.labelRemark.Location = new System.Drawing.Point(608, 80);
			this.labelRemark.Name = "labelRemark";
			this.labelRemark.Size = new System.Drawing.Size(120, 24);
			this.labelRemark.TabIndex = 228;
		...
		private void dateTimePicker1_ValueChanged(object sender, System.EventArgs e)
		{
			...
			dataGridAttend.DataSource = MyClassDatabase.GetAttandance(dateTimePicker1.Value.ToShortDateString(), comboBoxRemark.Text.ToString());
			dataGridAbsence.DataSource = MyClassDatabase.GetAbsence(dateTimePicker1.Value.ToShortDateString(), comboBoxRemark.Text.ToString());
			labelTotal1.Text = "Total Attend : " + MyClassDatabase.GetAttendanceCount(dateTimePicker1.Value.ToShortDateString(), comboBoxRemark.Text.ToString());
			labelTotal2.Text = "Total Absence : " + MyClassDatabase.GetAbsenceCount(dateTimePicker1.Value.ToShortDateString(), comboBoxRemark.Text.ToString());
		}
