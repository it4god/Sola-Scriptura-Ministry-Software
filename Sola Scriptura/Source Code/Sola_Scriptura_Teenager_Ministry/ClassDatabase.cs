...
namespace Teenager_Ministry
{
	...
	public class ClassDatabase
	{
		...
		public ClassDatabase()
		{
			...
			ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=GerejaDb.mdb";
		...
		public void SaveMember(Member MyMember)
		{
			try
			{
				...
				MyDataRow["ParentEmail"]= MyMember.ParentEmail.ToString();
				MyDataRow["FatherName"] = MyMember.FatherName.ToString();
				MyDataRow["MotherName"] = MyMember.MotherName.ToString();
				MyDataRow["ParentHP"] = MyMember.ParentHp.ToString();
				...
				MyDataRow["Talents"] = MyMember.Talents.ToString();
				MyDataRow["Hobbies"] = MyMember.Hobbies.ToString();
				...
				if(MyMember.MemberName.ToString()!="")
				{
					...
					while (myindex>=0)
					{
						...
						if(mysubstring.ToString().Trim()!="")
						{
							...
							strSQL += " or FatherName LIKE '%" + mysubstring + "%' ";
							strSQL += " or MotherName LIKE '%" + mysubstring + "%' ";
							strSQL += " or Phone LIKE '%" + mysubstring + "%' ";
							strSQL += " or HandPhone LIKE '%" + mysubstring + "%' ";
							
							
							strSQL += " or InChurch LIKE  '%" + mysubstring + "%' ";
							strSQL += " or Email LIKE '%" + mysubstring + "%' ";
							strSQL += " or ParentEmail LIKE '%" + mysubstring + "%' ";
							strSQL += " or ParentHP LIKE '%" + mysubstring + "%' ";
							strSQL += " or Talents LIKE '%" + mysubstring + "%' ";
							strSQL += " or Status LIKE '%" + mysubstring + "%' ";
							strSQL += " or Remark LIKE '%" + mysubstring + "%' ";
							strSQL += " or Hobbies LIKE '%" + mysubstring + "%' ";	
		...
		public DataTable GetAttandance(string MyDate, string Remark)
		{
			try
			{
				strSQL = "SELECT DISTINCT MemberName From Member INNER JOIN TheTransaction ON Member.MemberID = TheTransaction.MemberID WHERE theTransaction.MyDate = '" + MyDate + "' and Remark = '" + Remark.ToString() + "' ORDER BY 1";
				MyDataAdapter = new OleDbDataAdapter(strSQL,MyConnection);
				MyDataTable = new DataTable("Member");
				MyDataAdapter.Fill(MyDataTable);
				return MyDataTable;
		...
		public DataTable GetAbsence(string MyDate, string Remark)
		{
			try
			{
				strSQL = "SELECT DISTINCT MemberName From Member WHERE MemberID NOT IN (SELECT MemberID From TheTransaction WHERE theTransaction.MyDate = '" + MyDate + "' and Remark ='" + Remark.ToString() + "' ) and Remark = '" + Remark.ToString() + "' ORDER BY 1";
				MyDataAdapter = new OleDbDataAdapter(strSQL,MyConnection);
				MyDataTable = new DataTable("Member");
				MyDataAdapter.Fill(MyDataTable);
				return MyDataTable;
		...
		public string GetAttendanceCount(string MyDate, string Remark)
		{
		
			MyConnection.Close();
			MyConnection.Open();
			strSQL = "SELECT COUNT (MemberName) From Member INNER JOIN TheTransaction ON Member.MemberID = TheTransaction.MemberID WHERE theTransaction.MyDate = '" + MyDate + "' and Remark = '" + Remark.ToString() + "' ORDER BY 1";
			MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
			MyDataReader = MyOleDbCommand.ExecuteReader ();
			MyDataReader.Read();
			if(MyDataReader.GetInt32(0) >0)
		...
		public string GetAbsenceCount(string MyDate, string Remark)
		{
		
			MyConnection.Close();
			MyConnection.Open();
			strSQL = "SELECT COUNT (MemberName) From Member WHERE MemberID NOT IN (SELECT MemberID From TheTransaction WHERE theTransaction.MyDate = '" + MyDate + "' and Remark = '" + Remark.ToString() + "' ) and Remark = '" + Remark.ToString() + "' ORDER BY 1";
			MyOleDbCommand = new OleDbCommand(strSQL, MyConnection);
			MyDataReader = MyOleDbCommand.ExecuteReader ();
			MyDataReader.Read();
			if(MyDataReader.GetInt32(0) >0)
		...
		public DataTable GetChart(string MyDate, string MyDate2, string Remark)
		{
			try
			{
				strSQL = "SELECT  MyDate, theTransaction.MemberID AS Total From theTransaction, Member WHERE MyDate >= '" + MyDate + "' and MyDate <= '" + MyDate2 + "' and Remark = '" + Remark.ToString() +"' and Member.MemberID = TheTransaction.MemberID";
				MyDataAdapter = new OleDbDataAdapter(strSQL,MyConnection);
