...
Begin VB.Form FrmAddMatakuliah 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00DC7F59&
   ...
   Begin VB.Image imgLeft 
      Height          =   2310
      Left            =   240
      Picture         =   "FrmAddMataKuliah.frx":0000
      Top             =   5160
      Width           =   435
   End
   Begin VB.Label lblTitleAddMataKuliah 
      BackStyle       =   0  'Transparent
      Caption         =   "Add Mata Kuliah"
      BeginProperty Font 
         Name            =   "Verdana"
   ...
   Begin VB.Image imgVariation 
      Height          =   420
      Left            =   8760
      Picture         =   "FrmAddMataKuliah.frx":0B1C
      Top             =   360
      Width           =   2805
   End
   Begin VB.Image Image2 
      Height          =   495
      Left            =   240
      Picture         =   "FrmAddMataKuliah.frx":1606
      Stretch         =   -1  'True
      Top             =   2520
      Width           =   495
   End
   Begin VB.Image imgBg 
      Height          =   7695
      Left            =   0
      Picture         =   "FrmAddMataKuliah.frx":1ED7
      Stretch         =   -1  'True
      Top             =   120
      Width           =   11880
   End
End
Attribute VB_Name = "FrmAddMatakuliah"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim myitem As ClsItemServer
Dim rsMatakuliah As ADODB.Recordset

Private Sub Form_Load()
CenterChildForm2 Me
Set myitem = New ClsItemServer
Set rsMatakuliah = myitem.GetMK
Set DataGridMatakuliah.DataSource = rsMatakuliah
...
If (rsMatakuliah.RecordCount > 0) Then
    If Lite = "MKPerSem" Then
        frmMataKuliahPerSem.TxtMKNo.Text = Trim(DataGridMatakuliah.Columns(0).Value)
    ElseIf Lite = "" Then
