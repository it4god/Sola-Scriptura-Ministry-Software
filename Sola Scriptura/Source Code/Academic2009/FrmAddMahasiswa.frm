...
Begin VB.Form frmAddMahasiswa 
   ...
   Begin VB.ComboBox CboProgram 
      Height          =   315
      ItemData        =   "FrmAddMahasiswa.frx":0000
      Left            =   5160
      List            =   "FrmAddMahasiswa.frx":0013
      Style           =   2  'Dropdown List
      TabIndex        =   12
      Top             =   5040
      Width           =   3195
   ...
   Begin VB.Image Image5 
      Height          =   495
      Left            =   10920
      Picture         =   "FrmAddMahasiswa.frx":004A
      Top             =   7560
      Width           =   1980
   End
   Begin VB.Image Image4 
      Height          =   495
      Left            =   13080
      Picture         =   "FrmAddMahasiswa.frx":0B3E
      Top             =   7560
      Width           =   1980
   End
   Begin VB.Image ImgAddNew 
      Height          =   495
      Left            =   3360
      Picture         =   "FrmAddMahasiswa.frx":1632
      Top             =   7560
      Width           =   1980
   End
   Begin VB.Image imgLeft 
      Height          =   2310
      Left            =   2880
      Picture         =   "FrmAddMahasiswa.frx":2126
      Top             =   5760
      Width           =   435
   End
   Begin VB.Image imgVariation 
      Height          =   420
      Left            =   11760
      Picture         =   "FrmAddMahasiswa.frx":2C42
      Top             =   480
      Width           =   2805
   End
   ...
   Begin VB.Image imgQuit 
      Height          =   645
      Left            =   14280
      Picture         =   "FrmAddMahasiswa.frx":372C
      Top             =   1200
      Width           =   645
   End
   Begin VB.Image imgHelp 
      Height          =   690
      Left            =   14280
      Picture         =   "FrmAddMahasiswa.frx":408A
      Top             =   2040
      Width           =   645
   End
   Begin VB.Image Image1 
      Height          =   8055
      Left            =   240
      Picture         =   "FrmAddMahasiswa.frx":4ACB
      Stretch         =   -1  'True
      Top             =   240
      Width           =   2520
   End
   Begin VB.Image imgBg 
      Height          =   8055
      Left            =   2760
      Picture         =   "FrmAddMahasiswa.frx":65CD5
      Stretch         =   -1  'True
      Top             =   240
      Width           =   12480
   End
End
Attribute VB_Name = "frmAddMahasiswa"
...
Else
    Set myitem = New ClsItemServer
    saveok = myitem.AddMahasiswa(AddMahasiswaBuffer.Buffer)
