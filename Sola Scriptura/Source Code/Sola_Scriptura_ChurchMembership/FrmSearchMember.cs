...
{
	public class FrmSearchMember : Sola_Scriptura_ChurchMembership.FrmSearchMemberMaster
	{
		...
		internal System.Windows.Forms.DataGridTextBoxColumn dataGridTextBoxColumnMinistry;
		...
		internal System.Windows.Forms.DataGridTextBoxColumn dataGridTextBoxColumnIsBaptise1d;
		...
		private void InitializeComponent()
		{
			...
			this.dataGridTextBoxColumnIsBaptise1d = new System.Windows.Forms.DataGridTextBoxColumn();
			...
			this.dataGridTextBoxColumnMinistry = new System.Windows.Forms.DataGridTextBoxColumn();
			...
			this.dataGridTextBoxColumnEmail.HeaderText = "IsBaptised";
			this.dataGridTextBoxColumnEmail.MappingName = "Email";
			this.dataGridTextBoxColumnEmail.Width = 75;
			// 
			// dataGridTextBoxColumnIsBaptise1d
			// 
			this.dataGridTextBoxColumnIsBaptise1d.Format = "";
			this.dataGridTextBoxColumnIsBaptise1d.FormatInfo = null;
			this.dataGridTextBoxColumnIsBaptise1d.HeaderText = "IsBaptised";
			this.dataGridTextBoxColumnIsBaptise1d.MappingName = "IsBaptised";
			this.dataGridTextBoxColumnIsBaptise1d.Width = 75;
			// 
			...
			// 
			// dataGridTextBoxColumnMinistry
			// 
			this.dataGridTextBoxColumnMinistry.Format = "";
			this.dataGridTextBoxColumnMinistry.FormatInfo = null;
			this.dataGridTextBoxColumnMinistry.HeaderText = "Ministry";
			this.dataGridTextBoxColumnMinistry.MappingName = "Ministry";
			this.dataGridTextBoxColumnMinistry.Width = 75;
			// 
		...
		private void buttonShow_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				MyMDIForm.MyShowMemberForm.MdiParent = base.MyMDIForm;
				...
				MyMDIForm.MyShowMemberForm.textBoxCity.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,4].ToString().Trim();
				...
				MyMDIForm.MyShowMemberForm.textBoxState.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,6].ToString().Trim();
				MyMDIForm.MyShowMemberForm.textBoxCountry.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,7].ToString().Trim();
				MyMDIForm.MyShowMemberForm.textBoxPhone.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,8].ToString().Trim();
				MyMDIForm.MyShowMemberForm.textBoxHandPhone.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,9].ToString().Trim();
				MyMDIForm.MyShowMemberForm.textBoxEmail.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,10].ToString().Trim();
				
				MyMDIForm.MyShowMemberForm.comboBoxIsBaptized.Text  = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,11].ToString().Trim();
				MyMDIForm.MyShowMemberForm.textBoxInChurch.Text  = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,12].ToString().Trim();
				MyMDIForm.MyShowMemberForm.comboBoxStatus.Text  = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,13].ToString().Trim();
				MyMDIForm.MyShowMemberForm.comboBoxRemark.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,14].ToString().Trim();
				MyMDIForm.MyShowMemberForm.textBoxMinistry.Text = dataGridSearchMember[dataGridSearchMember.CurrentRowIndex,15].ToString().Trim();
