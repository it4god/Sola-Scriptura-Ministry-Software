...
namespace Sola_Scriptura_ChurchMembership
{
	...
	public class FrmLogin : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "Sola Scriptura Church Membership Program";
			// 
			// pictureBox7
			// 
			...
			this.label3.Text = "Church Membership Program";
			// 
			// label4
			// 
			...
			this.label4.Location = new System.Drawing.Point(272, 352);
