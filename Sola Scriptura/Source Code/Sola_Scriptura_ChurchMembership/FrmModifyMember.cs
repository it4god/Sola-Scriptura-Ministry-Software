...
{
	public class FrmModifyMember : Sola_Scriptura_ChurchMembership.FrmFormParent
	{
		...
		private void buttonModify_Click(object sender, System.EventArgs e)
		{
			if(buttonModify.Text.ToString()=="Edit") 
			{
				...
				MyMemberForm.textBoxCity.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,4].ToString().Trim();
				MyMemberForm.textBoxPostCode.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,5].ToString().Trim();
				MyMemberForm.textBoxState.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,6].ToString().Trim();
				MyMemberForm.textBoxCountry.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,7].ToString().Trim();
				MyMemberForm.textBoxPhone.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,8].ToString().Trim();
				MyMemberForm.textBoxHandPhone.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,9].ToString().Trim();
				MyMemberForm.textBoxEmail.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,10].ToString().Trim();
				
				MyMemberForm.comboBoxIsBaptized.Text  = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,11].ToString().Trim();
				MyMemberForm.textBoxInChurch.Text  = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,12].ToString().Trim();
				MyMemberForm.comboBoxStatus.Text  = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,13].ToString().Trim();
				MyMemberForm.comboBoxRemark.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,14].ToString().Trim();
				MyMemberForm.textBoxMinistry.Text = dataGridModifyMember[dataGridModifyMember.CurrentRowIndex,15].ToString().Trim();
