...
namespace Sola_Scriptura_Library
{
	...
	public class FrmSearchBookMiniForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBoxSubject.Location = new System.Drawing.Point(368, 168);
			...
			this.textBoxISBN.Location = new System.Drawing.Point(712, 72);
			...
			this.labelISBN.Location = new System.Drawing.Point(584, 72);
			...
			this.buttonClear.Location = new System.Drawing.Point(720, 224);
			...
			this.buttonSearch.Location = new System.Drawing.Point(824, 224);
			...
			this.comboBoxPublishYearFrom.Location = new System.Drawing.Point(712, 192);
			...
			this.comboBoxPublishYearTo.Location = new System.Drawing.Point(816, 192);
			...
			this.labelPublishYear.Location = new System.Drawing.Point(584, 192);
			...
			this.textBoxPublisher.Location = new System.Drawing.Point(368, 192);
			...
			this.labelPublisher.Location = new System.Drawing.Point(240, 192);
			...
			this.textBoxAuthor.Location = new System.Drawing.Point(712, 168);
			...
			this.labelAuthor.Location = new System.Drawing.Point(584, 168);
			...
			this.labelSubject.Location = new System.Drawing.Point(240, 168);
			...
			this.textBoxLC.Location = new System.Drawing.Point(712, 144);
			...
			this.labelLC.Location = new System.Drawing.Point(584, 144);
			...
			this.textBoxDDC.Location = new System.Drawing.Point(368, 144);
			...
			this.labelDDC.Location = new System.Drawing.Point(240, 144);
			...
			this.comboBoxBookGroup.Location = new System.Drawing.Point(712, 120);
			...
			this.labelBookGroup.Location = new System.Drawing.Point(584, 120);
			...
			this.comboBoxType.Location = new System.Drawing.Point(368, 120);
			...
			this.labelType.Location = new System.Drawing.Point(240, 120);
			...
			this.textBoxBookName.Location = new System.Drawing.Point(368, 96);
			...
			this.labelBookName.Location = new System.Drawing.Point(240, 96);
			...
			this.textBoxBookCode.Location = new System.Drawing.Point(368, 72);
			...
			this.labelBookCode.Location = new System.Drawing.Point(240, 72);
			...
			this.dataGridGetBook.Location = new System.Drawing.Point(232, 264);
			this.dataGridGetBook.Name = "dataGridGetBook";
			this.dataGridGetBook.ReadOnly = true;
			this.dataGridGetBook.Size = new System.Drawing.Size(680, 184);
		...
		private void dataGridGetBook_DoubleClick(object sender, System.EventArgs e)
		{
			...
			if(MyDataTable.Rows.Count>0)
			{
				if(MyCurrentData == "Borrow")
				{
					...
					MyTransactionBorrowForm.textBoxBookCode.Text  = dataGridGetBook[dataGridGetBook.CurrentRowIndex,0].ToString().Trim();
					MyTransactionBorrowForm.textBoxCopyNo.Text = dataGridGetBook[dataGridGetBook.CurrentRowIndex,1].ToString().Trim();
					MyTransactionBorrowForm.textBoxBookName.Text = dataGridGetBook[dataGridGetBook.CurrentRowIndex,2].ToString().Trim();
					this.Hide();
				}
			}	
		}
