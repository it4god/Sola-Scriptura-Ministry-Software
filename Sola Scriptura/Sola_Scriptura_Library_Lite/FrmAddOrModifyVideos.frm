...
Begin VB.Form FrmAddOrModifyVideos 
   AutoRedraw      =   -1  'True
   BackColor       =   &H80000005&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Add/Modify Videos"
   ClientHeight    =   5625
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7410
   ...
   Begin VB.ComboBox CboQuantity 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyVideos.frx":0000
      Left            =   1560
      List            =   "FrmAddOrModifyVideos.frx":0034
      TabIndex        =   8
      Top             =   3600
      Width           =   1575
   End
   ...
   Begin VB.ComboBox CboItemStatus 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyVideos.frx":006F
      Left            =   4920
      List            =   "FrmAddOrModifyVideos.frx":007C
      TabIndex        =   6
      Text            =   "B"
      Top             =   2640
      Width           =   1575
   ...
   Begin VB.ComboBox CboCategory 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyVideos.frx":008A
      Left            =   1560
      List            =   "FrmAddOrModifyVideos.frx":0091
      TabIndex        =   7
      Top             =   3120
      Width           =   1575
   End
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * From Videos  ORDER By ItemNo"
      Caption         =   "Videos"
   ...
   Begin MSAdodcLib.Adodc Adodc2 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * From Videos"
      Caption         =   "Videos"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin VB.Image Image1 
      Height          =   5610
      Left            =   0
      Picture         =   "FrmAddOrModifyVideos.frx":009A
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7455
   End
End
Attribute VB_Name = "FrmAddOrModifyVideos"
