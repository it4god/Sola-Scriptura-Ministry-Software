...
Begin VB.Form FrmAddOrModifyCDs 
   AutoRedraw      =   -1  'True
   BackColor       =   &H80000005&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Add/Modify CDs"
   ClientHeight    =   5625
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7410
   ...
   Begin VB.ComboBox CboQuantity 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyCDs.frx":0000
      Left            =   1560
      List            =   "FrmAddOrModifyCDs.frx":0034
      TabIndex        =   8
      Top             =   3600
      Width           =   1575
   End
   ...
   Begin VB.ComboBox CboItemStatus 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyCDs.frx":006F
      Left            =   4920
      List            =   "FrmAddOrModifyCDs.frx":007C
      TabIndex        =   6
      Text            =   "B"
      Top             =   2640
      Width           =   1575
   ...
   Begin VB.ComboBox CboCategory 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyCDs.frx":008A
      Left            =   1560
      List            =   "FrmAddOrModifyCDs.frx":00A6
      TabIndex        =   7
      Top             =   3120
      Width           =   1575
   End
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * From CDs ORDER By ItemNo"
      Caption         =   "Books"
   ...
   Begin VB.Image Image1 
      Height          =   5610
      Left            =   0
      Picture         =   "FrmAddOrModifyCDs.frx":00D1
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7455
   End
End
Attribute VB_Name = "FrmAddOrModifyCDs"
...
If TxtItemNo.Text = "" Then
    ...
    Exit Sub
Else
Adodc2.RecordSource = "SELECT * From CDs WHERE ItemNo = '" & TxtItemNo.Text & "'"
Adodc2.Refresh
