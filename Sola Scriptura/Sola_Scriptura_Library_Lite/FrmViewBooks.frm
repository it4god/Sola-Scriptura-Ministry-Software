...
Begin VB.Form FrmViewBooks 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "FrmViewBooks.frx":0000
      Height          =   5655
      Left            =   120
      TabIndex        =   4
      Top             =   840
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   $"FrmViewBooks.frx":0015
      Caption         =   "Adodc1"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   9.75
   ...
   Begin VB.Image Image1 
      Height          =   7170
      Left            =   0
      Picture         =   "FrmViewBooks.frx":0040
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9135
   End
End
Attribute VB_Name = "FrmViewBooks"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub CmdEdit_Click()
FrmAddOrModifyBooks.Hide
FrmAddOrModifyBooks.Show
If FrmAddOrModifyBooks.Adodc1.Recordset.RecordCount > 0 Then
    With FrmAddOrModifyBooks.Adodc1.Recordset
        .MoveFirst
        While Not .EOF
...
Select Case Index
Case 0
    Adodc1.RecordSource = "Select * from Books order by ItemNo"
    Text1.Visible = True
Case 1
    Adodc1.RecordSource = "Select * from Books order by title"
    Text1.Visible = True
End Select
Adodc1.Refresh
ArrangeGrid
...
If Option1(0).Value = True Then
        Adodc1.RecordSource = "Select * from Books where  ItemNo >= '" & Text1.Text & "' order by ItemNo"
Else
        Adodc1.RecordSource = "Select * from Books where title >= '" & Text1.Text & "' order by title"
End If
Adodc1.Refresh
ArrangeGrid
End Sub
