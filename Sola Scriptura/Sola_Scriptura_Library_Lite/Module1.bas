...
Public BorrowerData As Recordset
Public CurrentBorrower As Borrower
Public cnDatabase As Connection
Public themonth(1 To 12) As String
Public counter As Integer
Public itemitem As Integer
...
Public Sub Start()
    ...
    cnDatabase.Mode = adMoreReadWrite
    cnDatabase.Open "c:\Sola_Scriptura_Library_Lite\webcatalogue.mdb"
    For counter = 1 To 12
        themonth(counter) = MonthName(counter, True)
    Next counter
End Sub
