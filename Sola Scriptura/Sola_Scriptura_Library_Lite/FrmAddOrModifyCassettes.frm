...
Begin VB.Form FrmAddOrModifyCassettes 
   AutoRedraw      =   -1  'True
   BackColor       =   &H80000005&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Add/Modify Cassettes"
   ClientHeight    =   5625
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7410
   ...
   Begin VB.ComboBox CboItemStatus 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyCassettes.frx":0000
      Left            =   4920
      List            =   "FrmAddOrModifyCassettes.frx":000D
      TabIndex        =   6
      Text            =   "B"
      Top             =   2640
      Width           =   1575
   ...
   Begin VB.ComboBox CboQuantity 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyCassettes.frx":001B
      Left            =   1560
      List            =   "FrmAddOrModifyCassettes.frx":004F
      TabIndex        =   8
      Top             =   3600
      Width           =   1575
   End
   Begin VB.ComboBox CboCategory 
      ...
      DataSource      =   "Adodc1"
      Height          =   315
      ItemData        =   "FrmAddOrModifyCassettes.frx":008A
      Left            =   1560
      List            =   "FrmAddOrModifyCassettes.frx":00BB
      TabIndex        =   7
      Top             =   3120
      Width           =   1575
   End
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * From Cassettes ORDER By ItemNo"
      Caption         =   "Books"
   ...
   Begin MSAdodcLib.Adodc Adodc2 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * From Cassettes"
      Caption         =   "Books"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin VB.Image Image1 
      Height          =   5610
      Left            =   0
      Picture         =   "FrmAddOrModifyCassettes.frx":0105
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7455
   End
End
Attribute VB_Name = "FrmAddOrModifyCassettes"
...
CboQuantity.BackColor = vbYellow
...
If TxtItemNo.Text = "" Then
    ...
    Exit Sub
Else
Adodc2.RecordSource = "SELECT * From Cassettes WHERE ItemNo = '" & TxtItemNo.Text & "'"
Adodc2.Refresh
