...
namespace Sola_Scriptura_Library
{
	...
	public class FrmAbout : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label4.Location = new System.Drawing.Point(448, 416);
			this.label4.Name = "label4";
			this.label4.Size = new System.Drawing.Size(232, 80);
			this.label4.TabIndex = 66;
			this.label4.Text = "Developed  by : Jeffrey Lim                 Limpingen Soft Comp                  " +
				"                 http://limpingen.com                            Email : limping" +
				"en@yahoo.com";
			// 
			// oleDbConnection1
			// 
			this.oleDbConnection1.ConnectionString = @"Jet OLEDB:Global Partial Bulk Ops=2;Jet OLEDB:Registry Path=;Jet OLEDB:Database Locking Mode=0;Data Source=""C:\Sola_Scriptura_Library\Sola_Scriptura_Library\bin\Release\SolaScripturaDatabase.mdb"";Mode=Share Deny None;Jet OLEDB:Engine Type=5;Provider=""Microsoft.Jet.OLEDB.4.0"";Jet OLEDB:System database=;Jet OLEDB:SFP=False;persist security info=False;Extended Properties=;Jet OLEDB:Compact Without Replica Repair=False;Jet OLEDB:Encrypt Database=False;Jet OLEDB:Create System Database=False;Jet OLEDB:Don't Copy Locale on Compact=False;User ID=Admin;Jet OLEDB:Global Bulk Transactions=1";
			// 
			// FrmAbout
			// 
